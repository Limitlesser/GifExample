...
public class DiskLruCacheHelper {
    ...
    private DiskLruCache generateCache(Context context, File dir, int maxCount) throws IOException {
        ...
        int appVersion = context == null ? DEFAULT_APP_VERSION : BuildConfig.VERSION_CODE;
    ...
    public DiskLruCache.Editor editor(String key) {
        try {
            ...
            if (edit == null) {
                Log.d(TAG, "the entry spcified key:" + key + " is editing by other . ");
            }
            return edit;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public InputStream get(String key) {
        try {
            ...
            {
                Log.d(TAG, "not find entry , or entry.readable = false");
                return null;
            }
            //write READ
